...
module.exports = {
  ...
  SpotifySongAnnounce(track) {
    return (embed = {
      color: 0x1ed760,
      title: `<:spotify:775294970721992714> Song added`,
      description: `[${track.title}](${track.url})`,
    });
  },
  SpotifyListAnnounce(tracks) {
    return (embed = {
      color: 0x1ed760,
      title: `<:spotify:775294970721992714> Added ${tracks.length} tracks.`,
    });
  },
  SoundCloudSongAnnounce(track) {
    return (embed = {
      color: 0xff6d00,
      title: `<:soundcloud:775294969384140811> Song added`,
      description: `[${track.title}](${track.url})`,
    });
  },
  CustomSearchAnnounce(track) {
    return (embed = {
      color: 0x5c5c5c,
      title: `<:magnifying:775295981063241738> Song added`,
      description: `[${track.title}](${track.url})`,
    });
  },
