...
module.exports = {
  YouTubeSongAnnounce(track) {
    return (embed = {
      color: 0xff0000,
      title: `<:yt:775294971275378709> Song added [${track.requestedBy.username}]`,
  ...
  SpotifySongAnnounce(track) {
    return (embed = {
      color: 0x1ed760,
      title: `<:spotify:775294970721992714> Song added [${track.requestedBy.username}]`,
      description: `[${track.title}](${track.url})`,
    });
  },
  SpotifyListAnnounce(tracks) {
    return (embed = {
      color: 0x1ed760,
      title: `<:spotify:775294970721992714> Added ${tracks.length} tracks. [${tracks[0].requestedBy.username}]`,
    });
  },
  SoundCloudSongAnnounce(track) {
    return (embed = {
      color: 0xff6d00,
      title: `<:soundcloud:775294969384140811> Song added [${track.requestedBy.username}]`,
      description: `[${track.title}](${track.url})`,
    });
  },
  CustomSearchAnnounce(track) {
    return (embed = {
      color: 0x5c5c5c,
      title: `<:magnifying:775295981063241738> Song added [${track.requestedBy.username}]`,
      description: `[${track.title}](${track.url})`,
    });
  },
